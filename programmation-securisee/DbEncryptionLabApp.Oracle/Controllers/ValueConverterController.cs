...
public class ValueConverterController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        // Read raw (encrypted) data directly from Oracle
        var rawRows = await ReadRawRows("EMPLOYES_VALUE_CONVERTER");
        ...
        var vm = new PatternViewModel
        {
            ...
            PatternDescription = "Les donnees sont chiffrees de maniere transparente via les Value Converters d'EF Core. " +
                "L'API Data Protection de .NET gere les cles et le chiffrement (AES-256-CBC avec cles rotatives).",
